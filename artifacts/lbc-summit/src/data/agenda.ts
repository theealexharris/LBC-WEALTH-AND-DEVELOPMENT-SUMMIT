...
export const agenda: DayAgenda[] = [
  ...
  },
  {
    ...
    title: "Day 2",
    items: [
      { id: "d2-1", time: "8:30–9:00am", title: "Arrival, networking and continental refreshments", type: "break" },
      ...
      { id: "d2-10", time: "1:15–2:15pm", title: "Private implementation lab, direct speaker access, VIP closing reception", type: "vip" },
    ],
  },
];
