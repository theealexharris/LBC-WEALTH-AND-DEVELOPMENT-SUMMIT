...
export const agenda: DayAgenda[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "d2-2", time: "1:00–1:10pm", title: "Day Two opening and implementation challenge", type: "break" },
      { id: "d2-3", time: "1:10–2:10pm", title: "Keynote Speaker 2", type: "keynote" },
      { id: "d2-4", time: "2:10–2:25pm", title: "Break", type: "break" },
      { id: "d2-5", time: "2:25–3:05pm", title: "Featured Speaker 4", type: "featured" },
      { id: "d2-6", time: "3:05–3:45pm", title: "Featured Speaker 5", type: "featured" },
      { id: "d2-7", time: "3:45–4:15pm", title: "Guided implementation workshop", type: "workshop" },
      { id: "d2-8", time: "4:15–4:45pm", title: "Seven-speaker panel and audience Q&A", type: "panel" },
      { id: "d2-9", time: "4:45–5:00pm", title: "Commitments and closing message", type: "break" },
