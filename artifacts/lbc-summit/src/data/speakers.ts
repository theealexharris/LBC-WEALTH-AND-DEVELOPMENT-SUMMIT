...
export const speakers: Speaker[] = [
  ...
  {
    id: "featured-1",
    name: "Alexander M. Harris",
    title: "Speaker 1 – Day 1",
    company: "Redefined Mindset | Pinnacle AI Consulting",
    isKeynote: false,
    duration: "40 Minutes",
  ...
  },
  {
    ...
    isKeynote: false,
    duration: "40 Minutes",
    category: "Banking & Financial Leadership",
    ...
    bio: "Lamonte Lee is a banking professional, entrepreneur, and community leader with more than 22 years of experience at Farmers & Merchants Bank, where he has built a career focused on financial services, relationship management, and community development.\n\nRaised in Compton and later relocating to Long Beach, Lamonte overcame the challenges often associated with inner-city life. Growing up in an environment where many young men were expected to become statistics of gang violence and poverty, he chose a different path — one centered on leadership, service, and creating opportunities for others.\n\nToday, Lamonte is a partner at TreImage, a business development and brand licensing company that connects brands, businesses, and strategic opportunities. He is also the founder of the People's Chamber of Commerce and the 1 ME Foundation, organizations dedicated to empowering entrepreneurs, strengthening communities, promoting financial literacy, and creating pathways to economic success.\n\nThrough his work in banking, business, and community service, Lamonte remains committed to helping individuals and businesses achieve growth, build generational wealth, and realize their full potential. His journey from the streets of Compton to becoming a respected business and community leader serves as a testament to the power of perseverance, purpose, and vision.",
    photo: "/Lamont.png",
  },
  {
    id: "featured-4",
    ...
    isKeynote: false,
    duration: "40 Minutes",
    category: "AI & Tech. Entrepreneurship",
